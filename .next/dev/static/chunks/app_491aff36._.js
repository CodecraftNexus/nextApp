...
;
;
const SignInForm = ({ formData, onsubmit, UpdateField })=>{
    _s();
...
const authService = {
    verifyAuth: async ()=>{
        try {
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get('/api/users/me');
            return {
                success: true,
                user
            };
    ...
    login: async (credentials)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post('/api/users/login', credentials);
        return response;
    },
    register: async (userData)=>{
        return await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post('/api/users/register', userData);
    },
    logout: async ()=>{
        try {
...
_s(useAuth, "0a6JPuDDX+mIC+bGg0N3dLu4Qkk=", false, function() {
    return [
...
function AuthForms() {
    ...
    const { isAuthenticated, loading, login, successMessage, errors } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$UseAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(AuthForms, "NFriD8FmJyXO6az29abIAgtsk7k=", false, function() {
    return [
...
//# sourceMappingURL=app_491aff36._.js.map