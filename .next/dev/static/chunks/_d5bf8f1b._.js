...
const authService = {
    ...
    update: async (userData)=>{
        return await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].put("/api/profile", userData);
    },
    logout: async ()=>{
        try {
    ...
    getPlanet: async ()=>{
        try {
            const palentData = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post("/api/planethouse");
            return {
                success: true,
                palentData
            };
    ...
    getMahadaha: async ()=>{
        try {
            const MahadashaData = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post("/api/mahadasha");
            return {
                success: true,
                MahadashaData
            };
    ...
    getAnthardasha: async ()=>{
        try {
            const AnthardashaData = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post("/api/AntharDasha");
            return {
                success: true,
                AnthardashaData
            };
    ...
    googleLogin: async (idToken)=>{
        try {
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post('/api/auth/google-login', {
                idToken
            });
    ...
    setUsername: async (username)=>{
        try {
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post('/api/auth/set-username', {
                username
            });
            return {
                success: true,
...
const AuthProvider = ({ children })=>{
    ...
    const [planet, setPlanet] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [mahadasha, setmahadaha] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [anthardahsa, Setanthardahsa] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            const handleFocus = {
                "AuthProvider.useEffect.handleFocus": ()=>checkAuth()
            }["AuthProvider.useEffect.handleFocus"];
            window.addEventListener("focus", handleFocus);
            return ({
                "AuthProvider.useEffect": ()=>window.removeEventListener("focus", handleFocus)
            })["AuthProvider.useEffect"];
        }
    }["AuthProvider.useEffect"], [
        checkAuth
    ...
    const updateProfile = async (formData)=>{
        ...
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$authServices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].update(formData);
            await checkAuth();
        } catch (error) {
    ...
    const signUp = async (formdata)=>{
        ...
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$authServices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].register(formdata);
    ...
    const GetPlanet = async ()=>{
        try {
            setLoading(true);
            setPlanet(null);
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$authServices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].getPlanet();
            if (result.success) {
    ...
    const Getmahadasha = async ()=>{
        try {
            setLoading(true);
            setmahadaha(null);
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$authServices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].getMahadaha();
            if (result.success) {
    ...
    const getAntharDasha = async ()=>{
        try {
            setLoading(true);
            Setanthardahsa(null);
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$authServices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].getAnthardasha();
            if (result.success) {
    ...
    const handleGoogleLogin = async (idToken)=>{
        ...
        setErrors({});
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$authServices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].googleLogin(idToken);
    ...
    const handleSetUsername = async (username)=>{
        ...
        setErrors({});
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$authServices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].setUsername(username);
            if (!response?.user) {
                setErrors({
...
_s(AuthProvider, "PDWZmhVOoBoVoC27C8QOtX4pphA=", false, function() {
    return [
...
//# sourceMappingURL=_d5bf8f1b._.js.map